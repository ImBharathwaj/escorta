...
/** POST: Companion declines a video call request. No credits are used. */
export async function POST(
  ...
  if (payload.role !== "escort") return NextResponse.json({ error: "Only companions can decline" }, { status: 403 });
